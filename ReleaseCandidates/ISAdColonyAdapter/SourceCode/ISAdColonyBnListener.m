...
@implementation ISAdColonyBnListener

- (instancetype)initWithZoneId:(NSString *)zoneId andDelegate:(id<ISAdColonyBNDelegateWrapper>)delegate {
    self = [super init];
...
- (void)adColonyAdViewDidFailToLoad:(AdColonyAdRequestError * _Nonnull)error {
    [_delegate onBannerLoadFailWithError:error forZoneId:_zoneId];
}
