//
//  ISAdColonyRewardedVideoListener.m
//  ISAdColonyAdapter
//
...
@implementation ISAdColonyRewardedVideoListener
...
- (void)adColonyInterstitialDidLoad:(AdColonyInterstitial *)interstitial {
    [_delegate onRewardedVideoDidLoad:interstitial forZoneId:_zoneId];
}
...
- (void)adColonyInterstitialDidFailToLoad:(AdColonyAdRequestError *)error {
    [_delegate onRewardedVideoDidFailToLoad:_zoneId withError:error];
}
...
- (void)adColonyInterstitialExpired:(AdColonyInterstitial *)interstitial {
    [_delegate onRewardedVideoExpired:_zoneId];
}
