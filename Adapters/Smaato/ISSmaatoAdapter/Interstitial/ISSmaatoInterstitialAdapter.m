...
@interface ISSmaatoInterstitialAdapter ()

@property (nonatomic, strong) SMAInterstitial *interstitialAd;
@property (nonatomic, strong) ISSmaatoInterstitialDelegate *interstitialAdDelegate;

@end

@implementation ISSmaatoInterstitialAdapter
...
- (void)loadAdWithAdData:(ISAdData *)adData
    ...
    self.interstitialAdDelegate = [[ISSmaatoInterstitialDelegate alloc] initWithAdapter:self
                                                                    delegate:delegate];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [SmaatoSDK loadInterstitialForAdSpaceId:adSpaceId
...
- (BOOL)isAdAvailableWithAdData:(ISAdData *)adData {
    return self.interstitialAd != nil && self.interstitialAd.availableForPresentation;
}
