...
static NSString * const kPangleGDPRConsentMsg   = @"Manual configuration of GDPR information is no longer supported. Pangle will automatically read the settings from the CMP in the consent function.";
...
- (void)setConsent:(BOOL)consent {
    LogAdapterApi_Internal(kPangleGDPRConsentMsg);
}
