//
//  ISApplovinRewardedVideoListener.m
//  ISApplovinAdapter
//
...
@implementation ISApplovinRewardedVideoListener
...
- (void)adService:(ALAdService *)adService didFailToLoadAdWithError:(int)code {
    [_delegate onRewardedVideoDidFailToLoadWithError:code
                                              zoneId:_zoneId];
}
...
- (void)ad:(ALAd *)ad wasDisplayedIn:(UIView *)view {
    [_delegate onRewardedVideoDidOpen:view
                                    zoneId:_zoneId];
}
...
- (void)ad:(ALAd *)ad wasHiddenIn:(UIView *)view {
    [_delegate onRewardedVideoDidClose:view
                                 zoneId:_zoneId];
}
...
- (void)ad:(ALAd *)ad wasClickedIn:(UIView *)view {
    [_delegate onRewardedVideoDidClick:view
                                  zoneId:_zoneId];
}
...
- (void)videoPlaybackEndedInAd:(ALAd *)ad
    ...
    [_delegate onRewardedVideoDidEnd:_zoneId
                    didReceiveReward:wasFullyWatched];
}
